        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <a routerLink="/" class="flex items-center gap-3 group cursor-pointer">
            <div class="relative">
              ...
              <img
                src="/assets/branding/ryvl-mark.png"
                alt="RYVL Crest"
          ...
          <div class="hidden sm:flex items-center gap-3">
            ...
            <a
              ...
              class="btn-yellow px-4 py-2 rounded-lg text-xs font-extrabold tracking-wide uppercase transition shadow-lg shadow-[#EAE905]/15 flex items-center gap-1.5 cursor-pointer"
            >
          ...
          <div class="flex xl:hidden items-center gap-2">
            <a
              routerLink="/admin/dashboard"
              class="btn-yellow px-3 py-1.5 rounded-lg text-xs font-bold uppercase"
            >
              Admin
            </a>
            <button
        ...
        @if (mobileNavOpen()) {
          <div class="xl:hidden bg-[#0a0a0a] border-b border-[#EAE905]/20 px-4 pt-2 pb-6 space-y-1">
            ...
            <a
              (click)="mobileNavOpen.set(false)"
              routerLink="/performance"
              class="block px-3 py-2 rounded-lg text-sm font-bold uppercase text-[#EAE905] hover:bg-white/5"
            >
              RYVL Performance
            </a>
            <a
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div class="space-y-3">
              ...
              <ul class="space-y-2 text-xs text-slate-400">
                ...
                <li><a routerLink="/performance" class="hover:text-white transition">Team Performance</a></li>
