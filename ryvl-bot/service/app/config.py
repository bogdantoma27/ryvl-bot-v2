...
class Settings(BaseSettings):
    ...
    vpg_api_base_url: str = Field(default="https://api.virtualprogaming.com/public", alias="VPG_API_BASE_URL")
    vpg_cdn_base_url: str = Field(
        default="https://virtualprogaming.com/cdn-cgi/imagedelivery/cl8ocWLdmZDs72LEaQYaYw",
        alias="VPG_CDN_BASE_URL",
    )
    vpg_user_agent: str = Field(default="RYVLBot/1.0", alias="VPG_USER_AGENT")
    ...
    # Only upscales the final image posted to Discord (letterboxed); the in-app editor preview always renders at the native 900x1400 pitch size.
